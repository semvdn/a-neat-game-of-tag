...
4. **Terrain must be fair and readable.** Platforms may never overlap, including the full swept motion envelope of moving platforms. Fork choices must be reachable, branch routes must remain mutually exclusive after commitment, nested branches must preserve parent locks, and explicit merges must restore accessibility correctly.
